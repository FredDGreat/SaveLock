...
public class AutoScrollViewPager extends ViewPager {
    ...
    public void scrollOnce() {
        ...
        int totalCount = totalCount = adapter.getCount();
        ...
        if (nextItem < totalCount) {
            ...
            //Toast.makeText(getContext(),"nextItem"+nextItem,Toast.LENGTH_SHORT).show();
            if(isCycle) setCurrentItem(0, true);
        }
        //nextItem
        //HomeActivity.viewNextPageNumber(nextItem);
        //Toast.makeText(getContext(),"totalCount"+totalCount,Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || slideBorderMode == SLIDE_BORDER_MODE_CYCLE) {
            ...
            //Toast.makeText(getContext(),"currentItem == pageCount - 1"+(currentItem == pageCount - 1),Toast.LENGTH_SHORT).show();
        }
        getParent().requestDisallowInterceptTouchEvent(true);
        /**
